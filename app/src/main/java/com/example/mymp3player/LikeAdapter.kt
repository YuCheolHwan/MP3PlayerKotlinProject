...
class LikeAdapter(val context: Context, val likeFragment : TwoFragment,val musicList:MutableList<MusicData>):
    RecyclerView.Adapter<LikeAdapter.CustomViewHolder>() {
